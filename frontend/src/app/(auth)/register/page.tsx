...
import { ArrowRight, Briefcase, Lock, Mail,Eye,EyeOff } from "lucide-react";
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="w-full h-11 pl-10 pr-4 border-2 border-gray-300 rounded-md bg-white text-black"
                  required
                >
                ...
                {role === "jobseeker" && (
                  <div className="space-y-5 pt-4 border-t border-gray-400">
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                         <Lock className="icon-style z-10" />
                        <Input
                          id="resume"
                          type="file"
                        ...
                        />
                        <div className="h-11 flex items-center pl-10 pr-3 border-2 border-gray-300 rounded-md">
